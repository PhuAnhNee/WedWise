...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-sky-200 bg-opacity-50 backdrop-blur-sm z-50 transition-opacity duration-300">
      <div
      ...
      >
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Confirm Schedule Creation</h2>
        {error && (
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <p className="text-lg">
            ...
            <span className="text-gray-900">
              {selectedSlot} (
              {slots.find((s: Slot) => s.id === selectedSlot)?.time || "No information"})
            </span>
          </p>
        </div>
